...
public class MorestetDungeonTextModel 
{
private Scanner txtReader;
	...
	public void openFile()
	{
		try
		{
			txtReader = new Scanner(new File("TextFiles/MorestetDungeon.txt"));
		}
	...
	public void tyingAnimationForRooms(String roomDescription, TextArea navigationTextArea)
	{
    final Animation animation = new Transition()
    {
        {
            setCycleDuration(Duration.seconds(5.0));
        }
	...
	public void tyingAnimationForMonsters(String monster, TextArea navigationTextArea)
	{
    final Animation animation = new Transition()
    {
        {
        ...
        protected void interpolate(double frac) 
        {
            final int length = monster.length();
            final int n = Math.round(length * (float) frac);
            navigationTextArea.setText(monster.substring(0, n));
