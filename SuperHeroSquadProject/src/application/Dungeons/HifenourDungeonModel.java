...
public class HifenourDungeonModel 
{
	...
	public int getRoomNumber4MovingUp(int roomNumber)
	{
		...
		if(roomNumber == 4) return 5;
		if(roomNumber == 5) return 5;
		if(roomNumber == 6) return 4;
		if(roomNumber == 7) return 8;
		if(roomNumber == 8) return 8;
		if(roomNumber == 9) return 3;
	...
	public int getRoomNumber4MovingDown(int roomNumber)
	{
		...
		if(roomNumber == 0) return 10;
		if(roomNumber == 2) return 0;
		if(roomNumber == 3) return 9;
		if(roomNumber == 4) return 6;
		if(roomNumber == 5) return 4;
		if(roomNumber == 6) return 6;
		if(roomNumber == 7) return 7;
		if(roomNumber == 8) return 7;
